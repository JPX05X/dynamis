...
class FormHandler {
  ...
  async sendFormData(data) {
    // Get the current origin to include in the headers
    ...
    try {
      ...
      // If we get a CORS error, it will be caught in the catch block
      if (!response.ok) {
